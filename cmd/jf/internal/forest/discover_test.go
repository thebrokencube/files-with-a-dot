...
func TestFindForestFromSubdir(t *testing.T) {
	dir := t.TempDir()
	jfDir := filepath.Join(dir, ".jf")
	writeFile(t, filepath.Join(jfDir, "forest.yml"), "schema: 1\ndefaults:\n  sync: push\n")
	...
	if f == nil {
		t.Fatal("expected to find .jf/forest.yml")
	}
	if f.Dir != jfDir {
		t.Errorf("expected dir %q, got %q", jfDir, f.Dir)
	}
}
...
func TestDiscoverFlatDirectory(t *testing.T) {
	...
	jfDir := filepath.Join(dir, ".jf")
	writeFile(t, filepath.Join(jfDir, "one.md"), "---\njira: BEN-1\n---\n# One")
	writeFile(t, filepath.Join(jfDir, "two.md"), "---\njira: BEN-2\n---\n# Two")
	writeFile(t, filepath.Join(jfDir, "three.md"), "---\njira: BEN-3\n---\n# Three")
...
func TestDiscoverNestedWithREADME(t *testing.T) {
	...
	jfDir := filepath.Join(dir, ".jf")
	writeFile(t, filepath.Join(jfDir, "epics", "README.md"), "---\njira: BEN-100\n---\n# Epics")
	writeFile(t, filepath.Join(jfDir, "epics", "auth.md"), "---\njira: BEN-101\n---\n# Auth Epic")
	writeFile(t, filepath.Join(jfDir, "epics", "billing.md"), "---\njira: BEN-102\n---\n# Billing Epic")
...
func TestDiscoverPassthroughDirectory(t *testing.T) {
	...
	jfDir := filepath.Join(dir, ".jf")
	// Root README
	writeFile(t, filepath.Join(jfDir, "README.md"), "---\njira: BEN-1\n---\n# Root")
	// passthrough/ has no README.md with jira:
	writeFile(t, filepath.Join(jfDir, "passthrough", "child.md"), "---\njira: BEN-2\n---\n# Child")
...
func TestDiscoverMixedJiraAndNonJira(t *testing.T) {
	...
	jfDir := filepath.Join(dir, ".jf")
	writeFile(t, filepath.Join(jfDir, "tracked.md"), "---\njira: BEN-1\n---\n# Tracked")
	writeFile(t, filepath.Join(jfDir, "notes.md"), "# Just notes\n\nNo frontmatter")
	writeFile(t, filepath.Join(jfDir, "other.md"), "---\ntitle: Not Jira\n---\n# Other")
...
func TestDiscoverMultiRoot(t *testing.T) {
	...
	jfDir := filepath.Join(dir, ".jf")
	writeFile(t, filepath.Join(jfDir, "alpha", "README.md"), "---\njira: BEN-1\n---\n# Alpha")
	writeFile(t, filepath.Join(jfDir, "beta", "README.md"), "---\njira: BEN-2\n---\n# Beta")
...
func TestDiscoverDefaultsApplied(t *testing.T) {
	...
	writeFile(t, filepath.Join(dir, ".jf", "bare.md"), "---\njira: BEN-1\n---\n# Bare")
...
func TestDiscoverFrontmatterOverridesDefaults(t *testing.T) {
	...
	writeFile(t, filepath.Join(dir, ".jf", "override.md"), "---\njira: BEN-1\nsync: pull\ntype: Epic\n---\n# Override")
...
func TestDiscoverDeepNesting(t *testing.T) {
	...
	jfDir := filepath.Join(dir, ".jf")
	writeFile(t, filepath.Join(jfDir, "a", "README.md"), "---\njira: BEN-1\n---\n# A")
	writeFile(t, filepath.Join(jfDir, "a", "b", "README.md"), "---\njira: BEN-2\n---\n# B")
	writeFile(t, filepath.Join(jfDir, "a", "b", "leaf.md"), "---\njira: BEN-3\n---\n# Leaf")
...
func TestDiscoverOrderSort(t *testing.T) {
	...
	jfDir := filepath.Join(dir, ".jf")
	writeFile(t, filepath.Join(jfDir, "README.md"), "---\njira: BEN-1\n---\n# Root")
	writeFile(t, filepath.Join(jfDir, "z-last.md"), "---\njira: BEN-2\norder: 1\n---\n# Z Last")
	writeFile(t, filepath.Join(jfDir, "a-first.md"), "---\njira: BEN-3\norder: 2\n---\n# A First")
...
func TestDiscoverSkipsHiddenDirs(t *testing.T) {
	...
	jfDir := filepath.Join(dir, ".jf")
	writeFile(t, filepath.Join(jfDir, "visible.md"), "---\njira: BEN-1\n---\n# Visible")
	writeFile(t, filepath.Join(jfDir, ".hidden", "secret.md"), "---\njira: BEN-2\n---\n# Secret")
