...
3. `folio observe 'type(scope): description'` — append (validates format, auto-syncs: pulls before and pushes after)
...
Observe and resolve auto-sync by default (pull before mutate, push after) to prevent
