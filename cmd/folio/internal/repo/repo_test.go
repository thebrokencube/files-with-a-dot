...
func TestValidateCommitMessage(t *testing.T) {
	tests := []struct {
		...
		{"auto observe add", "auto(observe): add bug(cli)", false},
		{"auto observe add hyphen scope", "auto(observe): add task(my-scope)", false},
		{"auto observe resolve", "auto(observe): resolve 3 observations", false},
