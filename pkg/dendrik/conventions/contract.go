...
type ContractEntry struct {
	ID          string   // e.g. "G1", "K2", "B4"
	Layer       Layer    // which linter owns this check
	Scope       Scope    // universal or dendrik-specific
	Severity    Severity // error or warning
	Summary     string   // one-line description of the check
	Rationale   string   // why this check exists (shown by --explain)
	Remediation string   // concrete fix instructions (shown in lint output)
}

// Contract is the complete 25-check dendrik tool contract.
// Ordered by layer, then ID.
var Contract = []ContractEntry{
	// --- Go Layer (G1-G6) ---
	{
		ID: "G1", Layer: LayerGo, Scope: ScopeDendrik, Severity: SeverityError,
	...
	{
		ID: "G2", Layer: LayerGo, Scope: ScopeDendrik, Severity: SeverityError,
	...
	{
		ID: "G3", Layer: LayerGo, Scope: ScopeDendrik, Severity: SeverityError,
	...
	{
		ID: "G4", Layer: LayerGo, Scope: ScopeDendrik, Severity: SeverityError,
	...
	{
		ID: "G5", Layer: LayerGo, Scope: ScopeDendrik, Severity: SeverityError,
	...
	{
		ID: "G6", Layer: LayerGo, Scope: ScopeDendrik, Severity: SeverityWarning,
	...
	// --- Skill Layer (K1-K9) ---
	{
		ID: "K1", Layer: LayerSkill, Scope: ScopeUniversal, Severity: SeverityError,
	...
	{
		ID: "K2", Layer: LayerSkill, Scope: ScopeUniversal, Severity: SeverityError,
	...
	{
		ID: "K2-EXT", Layer: LayerSkill, Scope: ScopeUniversal, Severity: SeverityWarning,
	...
	{
		ID: "K3", Layer: LayerSkill, Scope: ScopeUniversal, Severity: SeverityError,
	...
	{
		ID: "K4", Layer: LayerSkill, Scope: ScopeUniversal, Severity: SeverityWarning,
	...
	{
		ID: "K5", Layer: LayerSkill, Scope: ScopeUniversal, Severity: SeverityError,
	...
	{
		ID: "K6", Layer: LayerSkill, Scope: ScopeDendrik, Severity: SeverityError,
	...
	{
		ID: "K7", Layer: LayerSkill, Scope: ScopeDendrik, Severity: SeverityError,
	...
	{
		ID: "K8", Layer: LayerSkill, Scope: ScopeDendrik, Severity: SeverityWarning,
	...
	{
		ID: "K9", Layer: LayerSkill, Scope: ScopeDendrik, Severity: SeverityError,
	...
	// --- Bridge Layer (B1-B9) ---
	{
		ID: "B1", Layer: LayerBridge, Scope: ScopeDendrik, Severity: SeverityError,
	...
	{
		ID: "B2", Layer: LayerBridge, Scope: ScopeDendrik, Severity: SeverityError,
	...
	{
		ID: "B3", Layer: LayerBridge, Scope: ScopeDendrik, Severity: SeverityError,
	...
	{
		ID: "B4", Layer: LayerBridge, Scope: ScopeUniversal, Severity: SeverityError,
	...
	{
		ID: "B5", Layer: LayerBridge, Scope: ScopeDendrik, Severity: SeverityError,
	...
	{
		ID: "B6", Layer: LayerBridge, Scope: ScopeDendrik, Severity: SeverityWarning,
	...
	{
		ID: "B7", Layer: LayerBridge, Scope: ScopeDendrik, Severity: SeverityError,
	...
	{
		ID: "B8", Layer: LayerBridge, Scope: ScopeDendrik, Severity: SeverityWarning,
		...
		Remediation: "Wrap raw JSON in a ResultEnvelope via dendrik.Output.Result(), or add //nolint:B8 if passthrough is intentional.",
	},
	{
		ID: "B9", Layer: LayerBridge, Scope: ScopeDendrik, Severity: SeverityWarning,
