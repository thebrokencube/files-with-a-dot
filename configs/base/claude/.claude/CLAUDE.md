...
- **Use git flags that change the target repo** — `git -C`, `--git-dir`, `--work-tree` all bypass the permission hook. Run git commands from the repo working directory (use `cd` first — see Tool Use).
